    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div
          ...
          className="bg-white p-6 rounded-xl shadow-sm border border-slate-100 cursor-pointer hover:shadow-md transition group"
        >
        ...
        >
          ...
          <div className="text-3xl font-bold text-slate-800 mb-1">
            R$ {metrics.monthlyCost.toFixed(2)}
          </div>
        ...
        <div className="bg-amber-600 rounded-xl shadow-lg shadow-amber-900/20 p-6 text-white flex flex-col justify-between">
          <div>
            ...
            <p className="text-amber-100 text-sm mb-6">
              Calcule custos e defina preços de venda em segundos com nossa ficha técnica
              inteligente.
            </p>
          </div>
          <button
