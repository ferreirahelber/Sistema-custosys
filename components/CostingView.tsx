...
export const CostingView: React.FC = () => {
  ...
  // --- LÓGICA DE VALIDAÇÃO (CORREÇÃO DO BUG) ---
  const totalTaxAndFees = taxRate + cardFee;
  // Verifica se a soma das porcentagens estoura 100%
  const isImpossibleMath = mode === 'margin' && (totalTaxAndFees + desiredMargin) >= 100;
  // Aviso preventivo se estiver muito perto do limite (ex: 95%)
  ...
  useEffect(() => {
    if (selectedRecipe && selectedRecipe.selling_price) {
      // Opcional: Pré-carregar o preço salvo se quisesse
    }
  }, [selectedRecipeId]);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
            ...
            <div className="space-y-6">
              ...
              {/* MOSTRADOR DE RESULTADO COM TRATAMENTO DE ERRO */}
              {isImpossibleMath ? (
