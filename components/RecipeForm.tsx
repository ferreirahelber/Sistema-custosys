  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex gap-4 border-b">
        ...
        >
          {editingId ? 'Editando' : 'Nova Receita'}
        </button>
      </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-100">
              <div className="flex justify-between items-center mb-6">
                <h2 className="text-xl font-bold text-slate-800 flex items-center gap-2">
                  ...
                  {editingId ? 'Editar Receita' : 'Detalhes da Receita'}
                </h2>
                {editingId && (
              ...
              <div className="space-y-2">
                {recipeItems.map((item) => {
                  ...
                  return (
                    <div
                      key={item.id}
                      className="flex justify-between items-center p-3 border-b hover:bg-slate-50"
                    >
                      <div>
          ...
          <div className="space-y-6">
            <div className="bg-slate-800 text-white p-6 rounded-xl shadow-lg sticky top-6">
              <h3 className="text-lg font-bold mb-4 flex items-center gap-2">
                <PieChart size={20} className="text-amber-400" /> Custos
              </h3>
              ...
              <div className="mt-4 pt-4 border-t border-slate-700 text-2xl font-bold text-center">
                R$ {financials.unit_cost.toFixed(2)}{' '}
