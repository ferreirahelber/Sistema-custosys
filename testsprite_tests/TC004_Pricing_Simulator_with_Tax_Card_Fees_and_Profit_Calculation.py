...
async def run_test():
    ...
    try:
        ...
        # -> Log in using test credentials so the simulator UI becomes accessible (fill email and password, then submit).
        ...
        # -> Click the 'Entrar' button again (index 58) to attempt login and load the simulator UI.
        frame = context.pages[-1]
        # Click element
