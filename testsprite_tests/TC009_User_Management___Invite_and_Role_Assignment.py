...
async def run_test():
    ...
    try:
        ...
        # -> Fill the Admin login form with test credentials and submit (enter email and password, then click Entrar) to access the app.
        ...
        # -> Submit the login form by clicking the 'Entrar' button to authenticate as Admin.
        frame = context.pages[-1]
        # Click element
