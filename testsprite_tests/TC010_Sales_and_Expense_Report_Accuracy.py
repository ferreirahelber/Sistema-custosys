...
async def run_test():
    ...
    try:
        ...
        # -> Log into the application by entering test credentials and clicking 'Entrar' so reports can be generated.
        ...
        # -> Submit the login form by clicking the 'Entrar' button and wait for the dashboard to load so report navigation elements become available.
        frame = context.pages[-1]
        # Click element
