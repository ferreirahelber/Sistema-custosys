...
async def run_test():
    ...
    try:
        ...
        # -> Log in with test credentials so the cashier flows can be executed. Fill E-mail and Senha then click Entrar.
        ...
        # -> Submit the login form again by clicking the Entrar button and wait briefly for the app to navigate to the dashboard.
        frame = context.pages[-1]
        # Click element
